...
export const videoContentAr: Record<string, LocalizedContent> = {
  ...
  "broll-02": { title: "خلف الكواليس — يوم تصوير استوديو", description: "تغطية عفوية من يوم تصوير كامل في الاستوديو." },
  "broll-03": { title: "لقطات بي-رول لجولة معمارية", description: "لقطات جيمبال سلسة تتحرك عبر مساحة مكتملة." },
  "broll-04": { title: "تفاصيل يوم الزفاف", description: "لقطات نسيج وتفاصيل منسوجة عبر فيلم زفاف." },
  "broll-05": { title: "بي-رول 05", description: "لقطات بي-رول." },
  ...
  "introoutro-01": { title: "مقدمة xFinta المميزة", description: "مقدمة متحركة بعلامة تجارية تُستخدم لافتتاح مشاريع الفيديو للعملاء." },
};
