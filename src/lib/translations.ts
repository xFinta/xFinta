...
const ar: Dictionary = {
  ...
  site: {
    ...
    bio: "أنا مرتضى الهاجري، أعمل تحت الاسم الإبداعي xFinta. أتخصص في أمرين: التصوير الفوتوغرافي الذي يجعل منتجًا أو مبنى أو يوم زفاف يبدو وكأنه ينتمي إلى مجلة، وإنتاج الفيديو الذي يمنح العلامات التجارية والقصص ثقلًا سينمائيًا حقيقيًا — لقطات B-roll والمقابلات والمقدمات والخواتيم التي تربط الفيديو معًا. كل مشروع يحصل على نفس المعيار: تكوين نظيف، إضاءة صادقة، ونتيجة نهائية تبدو راقية، لا نمطية.",
  },
  navLabels: {
    home: "الرئيسية",
    gallery: "المعرض",
